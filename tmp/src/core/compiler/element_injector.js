...
var ProtoElementInjectorInlineStrategy = (function () {
    function ProtoElementInjectorInlineStrategy(protoEI, bd) {
    ...
    ProtoElementInjectorInlineStrategy.prototype.hasBindings = function () { return lang_1.isPresent(this._binding0); };
    ProtoElementInjectorInlineStrategy.prototype.getBindingAtIndex = function (index) {
        if (index == 0)
    ...
    ProtoElementInjectorInlineStrategy.prototype.createElementInjectorStrategy = function (ei) {
        return new ElementInjectorInlineStrategy(this, ei);
    };
    return ProtoElementInjectorInlineStrategy;
})();
/**
 * Strategy used by the `ProtoElementInjector` when the number of bindings is more than 10.
 */
// TODO(vicb): add an interface
var ProtoElementInjectorDynamicStrategy = (function () {
    function ProtoElementInjectorDynamicStrategy(protoInj, bd) {
        var len = bd.length;
    ...
    ProtoElementInjectorDynamicStrategy.prototype.hasBindings = function () { return lang_1.isPresent(this._bindings[0]); };
    ProtoElementInjectorDynamicStrategy.prototype.getBindingAtIndex = function (index) {
        if (index < 0 || index >= this._bindings.length) {
            throw new OutOfBoundsAccess(index);
        }
        return this._bindings[index];
    };
    ProtoElementInjectorDynamicStrategy.prototype.createElementInjectorStrategy = function (ei) {
        return new ElementInjectorDynamicStrategy(this, ei);
    };
    return ProtoElementInjectorDynamicStrategy;
})();
...
var ElementInjectorInlineStrategy = (function () {
    ...
    ElementInjectorInlineStrategy.prototype.getComponentBinding = function () { return this._protoStrategy._binding0; };
...
var ElementInjectorDynamicStrategy = (function () {
    ...
    ElementInjectorDynamicStrategy.prototype.getComponentBinding = function () { return this._protoStrategy._bindings[0]; };
