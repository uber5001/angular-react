...
export class ReactNativeElement {
	...
	constructor(viewName: string, attributes = {}) {
		viewName = RCT_VIEW_NAMES[viewName];
		if (viewName === undefined) {
			console.log("Node viewName invalid: " + viewName + " ... defaulting to RCTView");
			viewName = RCT_VIEW_NAMES["view"];
		}
		...
		NativeModules.UIManager.createView(this.tag, viewName, newAttribs);
	}
